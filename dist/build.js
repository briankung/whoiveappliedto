...
__vue_options__.__file = "C:\\Users\\akwan\\github\\whoiveappliedto\\src\\components\\JobPost.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-348e0b19", __vue_options__)
  } else {
    hotAPI.reload("data-v-348e0b19", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] JobPost.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
var cache = __webpack_require__(0);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (!_vm.hideInstance) ? _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.showCard),
    ...
    staticClass: "JobPost",
    class: {
      'is-primary': _vm.selected, message: _vm.selected, card: !_vm.selected
    }
  }, [_c('header', {
    staticClass: "card-header"
  }, [_c('a', {
    staticClass: "card-header-icon is-pulled-left",
    on: {
    ...
    domProps: {
      "innerHTML": _vm._s(_vm.firstLine)
    },
    on: {
      "click": function($event) {
        if ($event.target !== $event.currentTarget) { return; }
        _vm.showCardContent = !_vm.showCardContent
      }
    }
  }), _vm._v(" "), _c('a', {
    staticClass: "card-header-icon is-pulled-right permahide",
    on: {
      "click": function($event) {
        _vm.hideInstance = true
      }
    }
  })]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.showCardContent),
      expression: "showCardContent"
    }],
  ...
  }), _vm._v(" "), _c('p'), _vm._v(" "), _c('p', [_c('small', [_vm._v("> "), _c('permalink', {
    attrs: {
      "id": _vm.id,
      "time": _vm.time
    }
  }), _vm._v(" by "), _c('userlink', {
    attrs: {
      "username": _vm.by
    }
  })], 1)])])]), _vm._v(" "), _c('footer', {
  ...
  }, [_vm._v(_vm._s(_vm.showNotes ? '[-]' : '[+]') + " Notes")]), _vm._v(" "), _c('label', {
    staticClass: "checkbox card-footer-item"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    domProps: {
      "checked": Array.isArray(_vm.saved) ? _vm._i(_vm.saved, null) > -1 : (_vm.saved)
    },
    on: {
      "change": function($event) {
        var $$a = _vm.saved,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.saved = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.saved = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.saved = $$c
        }
  ...
  }), _vm._v("\n       \n      "), _c('a', [_vm._v(_vm._s(this.saved ? 'Saved' : 'Save'))])]), _vm._v(" "), _c('label', {
    staticClass: "checkbox card-footer-item"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    domProps: {
      "checked": Array.isArray(_vm.applied) ? _vm._i(_vm.applied, null) > -1 : (_vm.applied)
    },
    on: {
      "change": function($event) {
        var $$a = _vm.applied,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.applied = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.applied = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.applied = $$c
        }
  ...
  }), _vm._v("\n       \n      "), _c('a', [_vm._v(_vm._s(this.applied ? 'Applied!' : 'Applied?'))])])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.showNotes),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-348e0b19", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-348e0b19!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./JobPost.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-348e0b19!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./JobPost.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_JobPost_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_JobPost_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_JobPost_vue__);


var cache = __webpack_require__(0)

var whoIsHiring = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#hn',
  data: {
    showAll: true,
    showAllNotes: false,
  ...
  components: {
    'job-post': __WEBPACK_IMPORTED_MODULE_1__components_JobPost_vue___default.a
  },
  // template: '<jobpost/>',
  // render: h => h(JobPost),
  methods: {
